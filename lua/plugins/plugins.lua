return {
  ...
  --     -- NOTE: this setting will be helpful if you do not want the PUM and floating win overlap
  --
  ...
  --       toggle_key = "<M-l>", -- toggle signature on and off in insert mode,  e.g. toggle_key = '<M-x>'
  --
