...
return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "<leader>tt", telescope.extensions.file_browser.file_browser, { silent = true, noremap = true })
    ...
    vim.keymap.set("n", "<leader>tb", OpenFileInFileBrowser, { desc = "Telescope explore current file in browser" })
